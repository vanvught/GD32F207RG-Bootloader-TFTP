...
DEFINES="-DGD32 -DGD32F20X -DGD32F20X_CL -DGD32F207RG -DBOARD_GD32F207RG -DPHY_TYPE=RTL8201F -DDISABLE_FS -DDISABLE_BIN -DNDEBUG -D_TIME_STAMP_YEAR_=2025 -D_TIME_STAMP_MONTH_=12 -D_TIME_STAMP_DAY_=29 -DCONFIG_STORE_USE_SPI -DCONFIG_TIMER6_HAVE_NO_IRQ_HANDLER -DCONFIG_HAL_USE_SYSTICK -DCONFIG_NET_APPS_NO_MDNS -DDEBUG_STACK -DNDEBUG -DDISABLE_JSON -DDISABLE_RTC -DDISABLE_FS -DDISABLE_PRINTF_FLOAT -DENABLE_TFTP_SERVER -DCONFIG_REMOTECONFIG_MINIMUM -DUDP_MAX_PORTS_ALLOWED=3 -DENET_RXBUF_NUM=2 -DENET_TXBUF_NUM=2 -DRTL8201F_LED1_LINK_ALL -DCONFIG_STORE_USE_SPI -D_TIME_STAMP_YEAR_=2025 -D_TIME_STAMP_MONTH_=12 -D_TIME_STAMP_DAY_=29 -DCONFIG_TIMER6_HAVE_NO_IRQ_HANDLER -DCONFIG_HAL_USE_SYSTICK -DCONFIG_HAL_USE_SYSTICK -DCONFIG_NET_APPS_NO_MDNS"
